{
  # Note: same flake.nix as espresso-sequencer but with go and postgres for cdk-validium-node,
  # commented out pre-commit hooks (for now).
  description = "cdk-validium-node, with go and rust development environment";
